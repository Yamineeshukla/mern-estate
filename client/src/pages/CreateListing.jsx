...
export default function CreateListing() {
  ...
  const[setImageUploadError,setImageUploadError]=useState(false);
    ...
    <main className="p-3 max-w-4xl mx-auto">
     ...
     <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          ...
          rounded-lg" id="description" maxLength='62' minLength='10'
           required
           onChange={handleChange}
          ...
          rounded-lg" id="address" maxLength='62' minLength='10' 
          required
          onChange={handleChange}
          ...
          <div className="flex items-center gap-2">
             <input type="number" id="bedrooms" min="1" max='10' required
              className="p-3 bordered border-gray-300 rounded-lg"
                onChange={handleChange}
          ...
          <div className="flex items-center gap-2">
             <input type="number" id="regular-Price" min="50" max='10000000' required
              className="p-3 bordered border-gray-300 rounded-lg"
               onChange={handleChange}
